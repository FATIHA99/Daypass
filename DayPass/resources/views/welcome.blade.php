                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-9 col-sm-10">
                        <div class="banner-content">
                            ...
                            <h4 class="sub-title wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">Daypass</h4>
                            <h1 class="banner-title mt-10 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="2s">
                                <span>Les plus beaux </span> hôtels du Maroc
                                <span> A la journée </span> 
                             </h1> 
                            <a class="banner-contact mt-25 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="2.3s" href="#contact">PISCINES ⋅ DÉJEUNERS ⋅ BRUNCHS ⋅ SPAS ⋅ FITNESS</a>
                            <div class="navbar-btn ml-20 d-none d-sm-block">
                                <a class="main-btn" href="/login"><i class="bi bi-box-arrow-in-right"></i>Connexion</a>
                            </div>
                        </div> <!-- banner content -->
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
            <div class="banner-image bg_cover rounded" style="background-image: url(assets/images/banner/banner-image.jpg)"></div>
        </div> <!-- header banner -->
    ...
    <section id="contact" class="contact-area pt-125 pb-130 gray-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-20">
                        <h5 class="sub-title mb-15">Vous êtes responsable d’un hôtel</h5>
                        <h2 class="title">Proposez vos offres sur Daypass Club</h2>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="single-form form-group">
                                        <input type="text" name="name" placeholder="votre nom" data-error="Name is required." required="required">
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-6">
                                    <div class="single-form form-group">
                                        <input type="email" name="email" placeholder="votre Email" data-error="Valid email is required." required="required">
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-6">
                                    <div class="single-form form-group">
                                        <input type="text" name="subject" placeholder="Votre établissement" data-error="Subject is required." required="required">
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="single-form form-group">
                                        <textarea placeholder="Décrivez vos offres et conditions (tarifs, horaires etc ...)" name="votre offres" data-error="Please,leave us a message." required="required"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-12">
                                   
                                        <input type="file" name="file"  placeholder="Phone" data-error="Phone is required." required="required" value="sdc">
                                        <div class="help-block with-errors"></div>
